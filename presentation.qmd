...
-   :nerd_face: Open Data excludes/inconveniences the industry @ross2022dynamics
-   :nerd_face: Lack of standards for sharing research materials @scheliga2014putting
-   :nerd_face: Open Infrastructure is not in place yet @banks2019answers @scheliga2014putting
-   :nerd_face: Open Data (a.o. FAIRification) takes more time @allen2019open @scheliga2014putting
-   :thinking: ... especially sharing sensitive data is more complex @scheliga2014putting
-   :thinking: Open Methods takes more time @allen2019open @scheliga2014putting
-   :thinking: Open Data has no clear legal guidelines, nor sanctions @scheliga2014putting

# Experiment 2: `literature`
...
## Result: Open Science helps honest reporting @allen2019open
...
:nerd_face: @banks2019answers @scheliga2014putting.
:::
:::
...
:nerd_face: see @scheliga2014putting on cultural and institutional constraints.
:::
:::
...
## Preregistration with statistical power 1/3
...
## Preregistration with statistical power 2/3 @simonsohn2020specification

::: columns
::: {.column width="60%"}
![](simonsohn2020specification_table_1_sub.png)
:::
...
## Preregistration with statistical power 3/3 @simonsohn2020specification
...
![Source: https://zenodo.org/records/10528857](poll_enlight_obstacles_modified_again_with_annotation.png)
